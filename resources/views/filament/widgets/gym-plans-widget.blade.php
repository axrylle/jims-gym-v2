                        ...
                        <div class="w-full md:w-2/3 p-6 text-center md:text-left">
                            ...
                            <div class="relative">
                                <button 
                                    ...
                                    class="bg-gray-200 px-4 py-2 rounded-lg text-gray-800 font-semibold hover:bg-gray-300 transition dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-100"
                                >
                                    Learn More
                                </button>
                                <div 
